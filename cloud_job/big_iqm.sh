...
basePath="/dataVault2025/dataPaper_IQM_eval3"
nSamp=40
backN=sirius
backN=garnet
#backN=emerald
...
for config in "${nqa_nqd_conf[@]}"; do
    ...
    #./submit_iqm_jobV2.py  --backend $backN --basePath  $basePath  --numQubits $nqa $nqd --numSample $nSamp --numShot ${shots}_000 --expName $expName -E ; continue
